...
<!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
             ...
             <div class=" panel panel-default">
              <div class="panel-heading">Update Budget (Debit)</div>
             <div class="panel-body">
           <?php   
                	$attributes = array('id'=>'login_form','class'=>'form_horizontal'); 
                      
                                        	echo form_open('Bajet/uploadbajet2',$attributes);
	...
	<script type="text/javascript" charset="utf-8">
              ...
              <div class="form-group" > 
                     ...
                     <div class="form-group" > 
                    <input type="text" name="sumber"class="form-control" placeholder="Sumber daripada ?"/><br> </div>
                     <div class="form-group" > 
                    <input type="number" name="diterima"class="form-control" placeholder="Jumlah Yang diterima (RM) ?"/><br></div>
                     <div class="form-group" > 
                    <input type="text" name="tarikh"class="form-control" placeholder="Tarikh menerima (dd/mm/yyyy)"/><br></div>
                     <div class="form-group" > 
