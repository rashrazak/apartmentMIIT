                    ...
                    <div class="col-lg-12">
                                ...
                                ?>
                                    <div class="tree-head img-tree grow push"> <a href="#" class="button tree-parent "> 
                                        ...
                                        <P><a class="btn-sm btn-info" href="<?php echo site_url("Carta/upd8/".$row1->id); ?>">Update</a></P>
                                    </div>
                                    ...
                                    <div class="row tree-row tree-child">
                                        ...
                                        <div class="col-md-2 col-sm-2 col-xs-2 img-tree grow push"> <a href="#" class="button tree-child<?php echo $i++; ?> "> 
                                            ...
                                            <p></p>
                                             ...
                                             <P><a class="btn-sm btn-info" href="<?php echo site_url("Carta/upd8/".$row2->id); ?>">Update</a></P>
                                        </div>
                             ...
                             <P><a class="btn-sm btn-info" href="<?php echo site_url("Carta/upd8/".$row3->id); ?>">Update</a></P>
                                        </div>
                                        <?php } ?> 
                             ...
                             <P><a class="btn-sm btn-info" href="<?php echo site_url("Carta/upd8/".$row4->id); ?>">Update</a></P>
                                        </div>
                                         <?php } ?> 
                             ...
                             <P><a class="btn-sm btn-info" href="<?php echo site_url("Carta/upd8/".$row5->id); ?>">Update</a></P>
                                        </div>
                                          <?php } ?> 
